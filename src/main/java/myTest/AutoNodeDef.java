...
@JsonPropertyOrder({
        ...
        "amountSignFlip",
        "totalNode",
        "sameLabelToBeGrouped",
        "showTotalNode",
        "qzInfo",
        "qzInfoCriterias",
        "criteria"
})
public class AutoNodeDef implements Serializable {
    ...
    /**
     * Used when labelExpression changes based on any criteria
     *
     */
    @JsonProperty("labelExpressionEvaluator")
    private String labelExpressionEvaluator;
    /**
    ...
    public String getLabelExpressionEvaluator() {
        return labelExpressionEvaluator;
    }

    public void setLabelExpressionEvaluator(String labelExpressionEvaluator) {
        this.labelExpressionEvaluator = labelExpressionEvaluator;
    }
